    ...
    try:
            ...
            if msg.contentType == 13:
               if wait["wblack"] == True:
                ...
                if msg.toType == 2:
                    ...
                    ki.updateGroup(X)
                    if wait["lang"] == "JP":
                        ki.sendText(msg.to,"Done Fluzzy")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kk.updateGroup(X)
                    if wait["lang"] == "JP":
                        kk.sendText(msg.to,"Done Fluzzy")
                    else:
                ...
                if msg.toType == 2:
                    ...
                    kc.updateGroup(X)
                    if wait["lang"] == "JP":
                        kc.sendText(msg.to,"Done Fluzzy")
                    else:
		...
		for ticket_id in n_links:
			if wait["atjointicket"] == True:
                ...
                kc.sendText(msg.to,Cmid)
            elif msg.text in ["Wkwk","wkwk","Wkwkwk","wkwkwk","Haha","haha","Hahaha","hahaha"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "100",
                ...
                ki.sendMessage(msg)
                kk.sendMessage(msg)
            elif msg.text in ["Please","please","pls","Pls"]:
                msg.contentType = 7
                msg.text = None
                msg.contentMetadata = {
                                     "STKID": "4",
